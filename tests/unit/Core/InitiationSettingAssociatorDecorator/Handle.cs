...
public sealed class Handle
{
    ...
    [Fact]
    public async Task ValidCommand_SetsInitiationBefore()
    {
        var fixture = FixtureFactory.Create<IAssociateArgumentsData>();
        ...
        fixture.InitiationSetterMock.InSequence(sequence).Setup(static (handler) => handler.Handle(It.IsAny<ISetProcessInitiationCommand>(), It.IsAny<CancellationToken>())).Returns(Task.CompletedTask);
