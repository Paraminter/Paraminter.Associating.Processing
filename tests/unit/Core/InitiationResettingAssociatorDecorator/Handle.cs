...
public sealed class Handle
{
    ...
    [Fact]
    public async Task ValidCommand_ResetsInitiationAfter()
    {
        var fixture = FixtureFactory.Create<IAssociateArgumentsData>();
        ...
        fixture.InitiationResetterMock.InSequence(sequence).Setup(static (handler) => handler.Handle(It.IsAny<IResetProcessInitiationCommand>(), It.IsAny<CancellationToken>())).Returns(Task.CompletedTask);
